...
async function main() {
    ...
    await prisma.university.update({
        ...
        data: {
            ...
            section2Text: `Hanoi Medical University (HMU) was established in 1902, making it one of the oldest and most prestigious medical universities in Kyrgyzstan and Southeast Asia. Over 120 years, HMU has trained more than 50,000 medical professionals who serve across Kyrgyzstan and internationally.\n\nHMU's world-class faculty, state-of-the-art research facilities, and strong hospital network at Bach Mai Hospital — one of Asia's largest — give students unparalleled clinical exposure. The university is WHO-listed, FAIMER-registered, and recognized by medical councils worldwide.\n\nInternational students benefit from English-medium instruction, dedicated support staff, and a vibrant community of students from 45+ countries.`,
            metaTitle: "Hanoi Medical University – MBBS in Kyrgyzstan | WHO Listed | NMC Approved",
            metaKeyword: "Hanoi Medical University, MBBS Kyrgyzstan, HMU, Study Medicine Kyrgyzstan, NMC Approved",
            metaDescription: "Study MBBS at Hanoi Medical University – Kyrgyzstan's oldest medical college, established 1902. WHO Listed, FAIMER registered, NMC approved. Fees from $4,500/year.",
            seoRating: 4.8,
            reviewNumber: 850,
            bestRating: 5.0,
            // Stats
    ...
    const reviews = [
        ...
        },
        {
            ...
            course: "MBBS",
            year: "2019",
            description: "Best decision of my life. Kyrgyzstan is safe, affordable and the people are warm. HMU's MBBS is internationally recognised and I plan to return to Ghana and apply for the medical council registration — the paperwork was all guided by the university.",
            rating: 4.8,
            position: 3,
        },
        {
        ...
        },
        {
            ...
            course: "MBBS",
            year: "2022",
            description: "I graduated from HMU and am now working as a physician in Canada. The degree was fully recognised here. The clinical skills I developed in Kyrgyzstan are what made me stand out during my residency interviews.",
            rating: 5.0,
            position: 5,
        },
        {
    ...
    const faqs = [
        ...
        { question: "What is the medium of instruction?", answer: "The entire MBBS programme is taught in English. However, students are encouraged to learn basic conversational Kyrgyz, and a language support module is provided in Year 1 to help interact with patients during clinical postings.", position: 3 },
        ...
        { question: "What is the FMGE pass rate for HMU graduates?", answer: "HMU consistently achieves an FMGE pass rate of 75–80%, which is among the highest for Kyrgyz medical universities. The 2024 pass rate was 80.0%. The university offers dedicated FMGE coaching in the final year of study.", position: 6 },
    ...
    const scholarships = [
        ...
        },
        {
            ...
            program: "MBBS",
            applicationMode: "Online",
            eligibility: ["International student (non-Kyrgyz)", "Family income below $15,000/year", "NEET qualified"],
    ...
    if (program) {
        await prisma.universityProgram.update({
            ...
            data: {
                ...
                whyChooseVietnam: "Kyrgyzstan offers MBBS education at a fraction of the cost of Western countries, with degrees recognised globally. The country is safe, culturally diverse, and features a low cost of living — making it ideal for international medical students.",
                ...
                year1Syllabus: "Anatomy, Physiology, Biochemistry, Introduction to Clinical Medicine, Kyrgyz Language (Basics), Medical Ethics",
