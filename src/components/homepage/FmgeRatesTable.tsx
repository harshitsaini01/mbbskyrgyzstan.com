                    ...
                    <div className="mt-4 flex flex-wrap gap-2">
                        ...
                        {universityFilter !== "all" && (
                            <span className="inline-flex items-center px-3 py-1 rounded-full text-xs font-medium bg-blue-100 text-blue-800">
                                ...
                                <button onClick={() => setUniversityFilter("all")} className="ml-2 text-blue-600 hover:text-blue-800" suppressHydrationWarning={true}>×</button>
                            </span>
                        )}
                        {yearFilter !== "all" && (
                            <span className="inline-flex items-center px-3 py-1 rounded-full text-xs font-medium bg-green-100 text-green-800">
                                Year: {yearFilter}
                                <button onClick={() => setYearFilter("all")} className="ml-2 text-green-600 hover:text-green-800" suppressHydrationWarning={true}>×</button>
                            </span>
                        )}
                        {search && (
                            <span className="inline-flex items-center px-3 py-1 rounded-full text-xs font-medium bg-purple-100 text-purple-800">
                                Search: &ldquo;{search}&rdquo;
                                <button onClick={() => setSearch("")} className="ml-2 text-purple-600 hover:text-purple-800" suppressHydrationWarning={true}>×</button>
                            </span>
                        )}
                    </div>
                )}
                    ...
                    <thead className="bg-gray-50 border-b border-gray-200">
                        <tr>
                            <th className="px-6 py-4 text-left text-sm font-semibold text-gray-900">
                                <button onClick={() => handleSort("universityName")} className="flex items-center gap-2 hover:text-red-600 transition-colors" suppressHydrationWarning={true}>
                            ...
                            <th className="px-6 py-4 text-center text-sm font-semibold text-gray-900">
                                <button onClick={() => handleSort("appeared")} className="flex items-center gap-2 hover:text-red-600 transition-colors" suppressHydrationWarning={true}>
                                    Total Applications <SortIcon field="appeared" />
                                </button>
                            </th>
                            <th className="px-6 py-4 text-center text-sm font-semibold text-gray-900">
                                <button onClick={() => handleSort("passed")} className="flex items-center gap-2 hover:text-red-600 transition-colors" suppressHydrationWarning={true}>
                                    Accepted Students <SortIcon field="passed" />
                                </button>
                            </th>
                            <th className="px-6 py-4 text-center text-sm font-semibold text-gray-900">
                                <button onClick={() => handleSort("passPercentage")} className="flex items-center gap-2 hover:text-red-600 transition-colors" suppressHydrationWarning={true}>
