...
export default function UniversityTrustSeals({ university }: Props) {
    const seals = [
        ...
        { icon: CheckCircle, title: "Ministry Licensed", subtitle: "Government of Kyrgyzstan", desc: "Licensed by the Ministry of Education & Science, Kyrgyzstan.", badge: "LICENSED", grad: "from-orange-500 to-red-500", badgeCls: "bg-orange-100 text-orange-800", active: university.ministryLicensed },
    ];
    const additional = [
