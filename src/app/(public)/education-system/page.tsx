...
export const metadata: Promise<Metadata> = buildMetadata({
    title: "Education System in Vietnam — MBBS Degree Structure | MbbsInVietnam.com",
    description: "Learn about Vietnam's medical education system, MBBS degree structure, NMC recognition, FMGE requirements, and how it compares to India's medical curriculum.",
    entitySeo: { metaKeyword: "vietnam education system, mbbs vietnam curriculum, vietnam medical degree, NMC approved vietnam, FMGE vietnam" },
    pageKey: "education-system",
});

const phases = [
    { year: "Year 1–2", phase: "Pre-Clinical", icon: BookOpen, color: "blue", desc: "Basic sciences — Anatomy, Physiology, Biochemistry, Community Medicine. Strong foundation in human body structure and function.", subjects: ["Anatomy", "Physiology", "Biochemistry", "Biophysics", "Vietnamese Language"] },
...
const faqs = [
    { q: "Is the Vietnam MBBS degree recognized in India?", a: "Yes. The Medical Council of India (NMC) recognizes Vietnam MBBS degrees from approved universities. Graduates must clear FMGE/NExT to practice in India." },
    { q: "What is the medium of instruction?", a: "Most Vietnamese medical universities teach in English for the first 2–3 years, transitioning partly to Vietnamese for clinical rotations. All exams are conducted in English." },
    { q: "How does the curriculum compare to India's?", a: "Vietnam follows a WHO-recommended curriculum similar to India's MBBS. The 6-year structure (including internship) maps directly to the NMC syllabus, making FMGE preparation straightforward." },
    { q: "What is the FMGE pass rate for Vietnam graduates?", a: "Vietnam MBBS graduates have one of the higher FMGE pass rates among foreign MBBS countries — averaging 35–45% in recent years, compared to 20–25% for some other countries." },
    { q: "Is there a NEET requirement?", a: "Yes. You must qualify NEET with at least 50th percentile to be eligible for MBBS admission in Vietnam (as per NMC regulations for foreign medical education)." },
];
        ...
        <div className="min-h-screen">
            ...
            <div className="max-w-7xl mx-auto px-4 py-16">
                <div className="text-center mb-12">
                    ...
                    <p className="text-gray-600 mt-4 max-w-2xl mx-auto">The Vietnamese MBBS follows a structured 6-year program (5 years academic + 1 year mandatory internship) aligned with NMC guidelines.</p>
                </div>
                ...
                <div className="max-w-7xl mx-auto px-4">
                    <div className="grid lg:grid-cols-2 gap-8">
                        <div className="bg-white rounded-2xl border border-gray-100 p-8">
                            ...
                            <p className="text-gray-600 mb-5">The National Medical Commission (India) recognizes MBBS from approved Vietnamese medical universities. NMC conducts periodic verifications of foreign medical institutions.</p>
                        ...
                        <div className="bg-white rounded-2xl border border-gray-100 p-8">
                            ...
                            <p className="text-gray-600 mb-5">Foreign Medical Graduates must clear FMGE (or NExT from 2025) to obtain an Indian medical license. Vietnam graduates are well-prepared due to curriculum alignment.</p>
                            <div className="space-y-3">
                                {["200 MCQ exam covering all MBBS subjects", "Minimum 50% marks required to pass", "Unlimited attempts (exam twice yearly)", "NExT will replace FMGE from 2025 onwards", "Vietnam avg pass rate: 35–45%"].map((p) => (
                                    <div key={p} className="flex items-start gap-3 text-sm text-gray-700">
            ...
            <div className="bg-gradient-to-r from-blue-600 to-blue-800 text-white py-14">
                <div className="max-w-4xl mx-auto px-4 text-center">
                    <h2 className="text-3xl font-bold mb-4">Ready to Apply for MBBS in Vietnam?</h2>
