...
type Facility = { id: number; name: string; iconName: string | null; status: boolean };
        ...
        <div className="max-w-2xl mx-auto space-y-6">
            <div className="flex items-center gap-3">
                ...
                <div>
                    ...
                    <p className="text-sm text-gray-500">Manage facility types that can be linked to universities (e.g. Hostel, Library, Lab)</p>
                </div>
            </div>
            ...
            <div className="bg-white rounded-xl border border-gray-200 overflow-hidden">
                ...
                {loading ? (
                    ...
                    <div className="p-8 text-center text-gray-400">No facilities yet. Add your first facility above.</div>
                ) : (
