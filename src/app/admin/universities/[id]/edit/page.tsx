    ...
    useEffect(() => {
        fetch(`/api/admin/universities/${id}`)
            ...
            .then((data) => {
                ...
                setForm({ ...data, thumbnail: data.thumbnailPath ?? null, brochure: data.brochurePath ?? null, embassyLetter: data.embassyLetterPath ?? null, universityLicense: data.universityLicensePath ?? null, aggregationLetter: data.aggregationLetterPath ?? null });
                setLoading(false);
            })
