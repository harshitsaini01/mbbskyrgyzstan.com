...
type FormData = {
    ...
    // Media
    thumbnail: string | null; section2Image: string | null; brochure: string | null;
...
const defaultForm: FormData = {
    ...
    thumbnail: null, section2Image: null, brochure: null,
    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        try {
            const payload = {
                ...
                students: form.students ? parseInt(form.students) : null,
                ...
                globalRanking: form.globalRanking ? parseInt(form.globalRanking) : null,
